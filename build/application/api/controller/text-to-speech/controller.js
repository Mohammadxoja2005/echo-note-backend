...
let TextToSpeechSpeechController = class TextToSpeechSpeechController {
    ...
    convertAudioToText(file, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const tempPath = path.join(`${process.env.BASE_PATH}/echo-note-backend/webm-files`, clientUploadedFileName);
            fs.writeFileSync(tempPath, file.buffer);
            console.time("full request");
            console.log("before request");
            yield this.converterAudioToTextUseCase.execute(userId, tempPath);
